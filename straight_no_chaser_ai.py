...
def out_of_reach(paddle_frect, trajectory, me):
    ...
    if me:
	return distance_to_ball - trajectory['time'] > paddle_frect.size[1]*0.5 + 45*trajectory['walls']
    else:
	return distance_to_ball - trajectory['time'] > paddle_frect.size[1]*0.5 + 20*trajectory['walls']
